...
![Version](https://img.shields.io/badge/vers%C3%A3o-v1.5.0-blue)
...
Baixe o `csv-cascade-filter.html` mais recente na [página de Releases](https://github.com/Sarpa-m/csv-cascade-filter/releases/latest).
